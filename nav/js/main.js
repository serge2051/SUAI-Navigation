...
function InitSVGMap()
{
	...
	var menuBar = document.getElementById("block_menu");
	if (menuBar!=null)
		searchBarHeight = menuBar.offsetHeight;
...
function CheckUrlVars()
{
	...
	if (src!=null)
	{
		document.getElementById("input_path_srcRoomBox").value = src;
		document.getElementById("input_path_srcRoomBox_d").value = src;
		if (dst!=null)
		{
			document.getElementById("input_path_dstRoomBox").value = dst;
			document.getElementById("input_path_dstRoomBox_d").value = dst;
	...
	else
	{
		if (dst!=null)
		{
			document.getElementById("input_aud_dstRoomBox").value = dst;
			document.getElementById("input_aud_dstRoomBox_d").value = dst;
			FindAudDesktop(true);
		}
	}
}
...
function ShowCustomAlert(alertText)
{
	...
	$('#dstRoomBox').popover('show');
	timeout = setTimeout(function() 
					{
						$('#dstRoomBox').popover('hide');
					},2500);
};
...
function autocomplete_create(inp, arr, maxElements)
{
	var currentFocus;
	inp.addEventListener("input", function(e)
	{
		...
		a.setAttribute("style","border:0;font-weight:100;width:"+inp.getBoundingClientRect().width + "px;");
